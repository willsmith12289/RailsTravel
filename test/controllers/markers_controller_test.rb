...
class MarkersControllerTest < ActionController::TestCase
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { address: @marker.address, info: @marker.info, latitude: @marker.latitude, longitude: @marker.longitude, map_id: @marker.map_id, title: @marker.title }
    end
  ...
  test "should update marker" do
    patch :update, id: @marker, marker: { address: @marker.address, info: @marker.info, latitude: @marker.latitude, longitude: @marker.longitude, map_id: @marker.map_id, title: @marker.title }
    assert_redirected_to marker_path(assigns(:marker))
  end

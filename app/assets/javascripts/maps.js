	...
	function addEvent(iWindow) {
		...
		calForm.innerHTML =
			"<form class='new_event' id='new_event' enctype='multipart/form-data' action='/events' method='post'>" +
				"<p><input type='text' name='event[name]' id='event_name'></p>" +
				"<p><input type='text' name='event[map_id]' id='event_map_id' value='" + mapId + "'></p>" +
				"<div class='field'><select id='event_start_time_1i' name='event[start_time(1i)]'>" +
				...
				"<p><input type='submit' value='Create Event' name='commit'></p>" +
			"</form>";
